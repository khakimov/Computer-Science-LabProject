...
#define EMSUM -4 /* Error matrices are not equal */
#define EMDIFF -5
#define EMTRASP -6
#define EMPROD -7 /* Error the matrices haven't the correct row and col in order to do the vectorial product */
#define EMCOORD -8 /* Error in selecting the position in which will be located the element that will be selected from the matrix */
#define EMPAR1 -9 /* The matrix passed as a parameters for the function is incorrect */
#define EMPAR2 -10 /* The matrix passed as second parameter for the calling function is incorrect */
#define EMFNR -11 /* Was found an error while reading the file */
#define EMNEQ -12
